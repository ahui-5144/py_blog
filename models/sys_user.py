...
from sqlalchemy import String, DateTime, Boolean, BigInteger, text, Index
...
class SysUser(Base):
    ...
    id: Mapped[int] = mapped_column(BigInteger, primary_key=True, index=True, autoincrement=True, comment="用户id")
